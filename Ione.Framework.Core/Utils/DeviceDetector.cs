...
namespace Belant.Framework.Core.Utils
{
    public class DeviceDetector
    {
        ...
        static readonly string[] dellModel = new string[] { "Venue 8 Pro 5830" };
        static readonly KnonwnHardwareKind[] dellModelKind = new KnonwnHardwareKind[] { KnonwnHardwareKind.DellPro8 };
        ...
        static readonly string[] msModel = new string[] { "Surface with Windows 8 Pro", "Surface Pro 2", "Surface Pro 3" };
        static readonly KnonwnHardwareKind[] msModelKind = new KnonwnHardwareKind[] { KnonwnHardwareKind.SurfacePro, KnonwnHardwareKind.SurfacePro2, KnonwnHardwareKind.SurfacePro3 };

...
namespace Belant.Framework.Soap
{
    /// <summary>
    /// Model
    /// abstract Model SOAP
    ...
    public abstract class Model : IModel, IModelType
    {
        ...
        public virtual object ExecuteAsync(object input, FormOperationType operation = FormOperationType.Execute)
        {
            StartExecution();
        ...
        /// <param name="operation">FormOperationType</param>
        /// <returns>object</returns>
        public virtual async Task<object> ExecuteTask(object input, FormOperationType operation = FormOperationType.Execute)
        {
            return await Task.Run(() => ExecuteAsync(input, operation));
        }
        ...
        public virtual object SelectAsync(object input)
        {
            StartExecution();
        ...
        /// <param name="input">SelectInput</param>
        /// <returns>object</returns>
        public virtual async Task<object> SelectTask(object input)
        {
            return await Task.Run(() => SelectAsync(input));
        }
        ...
        public virtual object UploadAsync(object input, FormOperationType operation = FormOperationType.Execute)
        {
            StartExecution();
        ...
        /// <param name="operation">FormOperationType</param>
        /// <returns>object</returns>
        public async Task<object> UploadTask(object input, FormOperationType operation = FormOperationType.Execute)
        {
            return await Task.Run(() => UploadAsync(input, operation));
        }
        ...
        /// <param name="operation">FormOperationType</param>
        /// <returns>object</returns>
        public async Task<object> DownloadTask(object input, FormOperationType operation = FormOperationType.Execute)
        {
            return await Task.Run(() => Download(input, operation));
        }
        ...
        /// <returns>object</returns>
        public object SumAsync(object input)
        {
            StartExecution();
        ...
        /// <param name="input">SumInput</param>
        /// <returns>object</returns>
        public async Task<object> SumTask(object input)
        {
            return await Task.Run(() => SumAsync(input));
        }
        ...
        /// <returns></returns>
        public T SelectAsync<T>(object input) where T : new()
        {
            return (T)this.SelectAsync(input);
        }
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public T SumAsync<T>(object input) where T : new()
        {
            return (T)this.SumAsync(input);
        }
        ...
        /// <returns>T</returns>
        public T ExecuteAsync<T>(object input, FormOperationType operation = FormOperationType.Execute) where T : new()
        {
            return (T)this.ExecuteAsync(input, operation);
        }
        ...
        /// <param name="operation"></param>
        /// <returns>T</returns>
        public T UploadAsync<T>(object input, FormOperationType operation = FormOperationType.Execute) where T : new()
        {
            return (T)this.UploadAsync(input, operation);
        }
        ...
        /// <param name="input"></param>
        /// <returns>T</returns>
        public async Task<T> SelectTask<T>(object input) where T : new()
        {
            return await Task.Run(() => (T)SelectAsync(input));
        }
        ...
        /// <param name="input"></param>
        /// <returns>T</returns>
        public async Task<T> SumTask<T>(object input) where T : new()
        {
            return await Task.Run(() => (T)SumAsync(input));
        }
        ...
        /// <param name="operation"></param>
        /// <returns>T</returns>
        public async Task<T> ExecuteTask<T>(object input, FormOperationType operation = FormOperationType.Execute) where T : new()
        {
            return await Task.Run(() => (T)ExecuteAsync(input, operation));
        }
        ...
        /// <param name="operation"></param>
        /// <returns>T</returns>
        public async Task<T> UploadTask<T>(object input, FormOperationType operation = FormOperationType.Execute) where T : new()
        {
            return await Task.Run(() => (T)UploadAsync(input, operation));
        }
